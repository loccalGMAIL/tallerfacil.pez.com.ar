    ...
    <table class="w-full text-sm table-cards dark-cards">
        ...
        <tbody class="divide-y divide-gray-700">
            ...
            <tr class="hover:bg-gray-750 transition-colors">
                ...
                <td class="px-4 py-3 text-gray-400 font-mono text-xs" data-label="Subdominio">{{ $taller->subdominio }}</td>
                <td class="px-4 py-3 text-gray-300" data-label="Usuarios">{{ $taller->usuarios_count }}</td>
                <td class="px-4 py-3" data-label="Suscripción">
            ...
            @empty
            <tr>
                <td colspan="6" class="px-4 py-8 text-center text-gray-500 td-vacio">No hay talleres registrados.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
